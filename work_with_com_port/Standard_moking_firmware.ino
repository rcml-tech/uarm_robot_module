        ...
        if(dataBuf[8] & RESET)
        {
            ...
            *((char *)(&handRotTemp )+1)  = dataBuf[6]; 
             ...
             Serial.print("stretchTemp ");
              ...
              Serial.print("\n rotationTemp ");
              Serial.print(rotationTemp);
              Serial.print("\n handRotTemp");
              Serial.print(handRotTemp);
              Serial.print("\n");
...
void uarmReset(){
  ...
  uarm.setServoSpeed(SERVO_R,    10);  // 0=full speed, 1-255 slower to faster
  uarm.setServoSpeed(SERVO_L,    10);  // 0=full speed, 1-255 slower to faster
  uarm.setServoSpeed(SERVO_ROT, 10);  // 0=full speed, 1-255 slower to faster
}

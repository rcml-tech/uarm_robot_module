...
| servo1 | max             | min            | ось изменения угла первого сервопривода.                                                                                         |
| servo2 | max             | min            | ось изменения угла второго сервопривода.                                                                                         |
| servo3 | max             | min            | ось изменения угла третьего сервопривода.                                                                                        |
| servo4 | max             | min            | ось изменения угла четвертого сервопривода.                                                                                      |
| X      | max             | min            | перемещение по оси x.                                                                                      |
| Y      | max             | min            | перемещение по оси y.                                                                                      |
| Z      | max             | min            | перемещение по оси z.                                                                                      |

Граничные значения min/max для осей задаются в конфигурационном файле.
В секции настройки осей:
